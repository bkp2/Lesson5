...
for point in range(N):
    points.append(sd.get_point(sd.random_number(0, 100), 600))
    # print(snowflakes[snowflake])
x, y = sd.random_number(0, 100), 600

lengths = []
for length in range(N):
    lengths.append(sd.random_number(1, 20))
...
while True:
    ...
    for snowflake in range(N):
        ...
        if points[snowflake].y < 100+length:
